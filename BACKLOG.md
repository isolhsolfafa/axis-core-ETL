...
> 마지막 업데이트: 2026-03-09 (Sprint 1 launch)
...
| 1 | UPSERT 전환 + 연도 필터링 + finishing_plan_end 적재 | 🔧 진행 중 |

---

## 진행 중

### Sprint 1: UPSERT + 연도 필터링 + 마무리계획종료일 — 🔧

상세: `docs/SPRINT_1.md` 참조
...
### 1. 변경 감지 로그 + 모니터링
- **내용**: UPSERT 시 신규/변경/동일 건수 카운트 + Slack/Teams 알림
- **목적**: 매주 cron 실행 결과 모니터링 ("총 120건 중 신규 3건, 변경 5건, 동일 112건")
- **시기**: Sprint 1 완료 후
